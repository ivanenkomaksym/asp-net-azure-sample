...
function updateUI(data, endpoint) {
    ...
    } else if (endpoint === clientConfig.weatherForecastURI) {
        weatherForecastDiv.innerHTML = ''
        const date = document.createElement('p');
        date.innerHTML = "<strong>date: </strong>" + data[0].date;
        const tempC = document.createElement('p');
        tempC.innerHTML = "<strong>tempC: </strong>" + data[0].temperatureC;
        const tempF = document.createElement('p');
        tempF.innerHTML = "<strong>tempF: </strong>" + data[0].temperatureF;
        const summary = document.createElement('p');
        summary.innerHTML = "<strong>summary: </strong>" + data[0].summary;
